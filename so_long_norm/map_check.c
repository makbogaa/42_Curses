...
/*   Updated: 2025/03/16 22:47:10 by makboga          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int is_player_surrounded(t_map *map)
{
    ...
    if (px - 1 >= 0 && (map->mappin[px - 1][py] == '1' || map->mappin[px - 1][py] == 'E'))
        walls_or_end_count++;
    if (px + 1 < map->h && (map->mappin[px + 1][py] == '1' || map->mappin[px + 1][py] == 'E'))
        walls_or_end_count++;
    if (py - 1 >= 0 && (map->mappin[px][py - 1] == '1' || map->mappin[px][py - 1] == 'E'))
        walls_or_end_count++;
    if (py + 1 < map->w && (map->mappin[px][py + 1] == '1' || map->mappin[px][py + 1] == 'E'))
        walls_or_end_count++;
